...
class UserAssign extends Component {
    ...
    * the admin user can then see where the user has permissions and where to change to*/
    ...
    /*this event is triggered when the admin user clicks on the grant access button to make changes to a users
    * permissions, the request is sent to the backend to make the changes*/
